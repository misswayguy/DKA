...
if __name__ == "__main__":
    data_dir = "/mnt/data/lsy/ZZQ/Breast_Ultr_sound_Images_Dataset_full"  # 原始数据集路径
    output_dir = "/mnt/data/lsy/ZZQ/Breast_Ultr_sound_Images_Dataset_cross_validation_v2"  # 输出路径
    train_ratios = [0.6, 0.4, 0.2,0.1, 0.01, 0.005, 0.001]  # 训练集比例
    num_folds = 5  # 折数
